...
Partial Public Class DemoRunner
    ...
    Public Sub CreateDemo(demo As DemoDefinition)
        ...
        Select Case demo.Id
            ...
            Case "pq_0023"
                CreatePQ_Formel_Pivot_Demo()
            Case "pq_0024"
                CreatePQ_Formel_1_Demo()
            Case "pq_0025"
                CreatePowerQueryDemo_25()
            Case "formula_001"
                CreateFormulaDemo_1()
            Case "formula_002"
                CreateFormulaDemo_2()
    ...
    Private Sub CreatePowerQueryDemo_20()
        ...
        End Try
    End Sub
    Private Sub CreatePowerQueryDemo_25()
        Try
            Dim workbook As Excel.Workbook =
                DemoPackageManager.ExtractAndOpen(
                    App,
    ...
    Private Sub CreateFormelDemo_9()
        ...
        End Try
    End Sub
    Private Sub CreateFormelDemo_14()
        Try
            Dim workbook As Excel.Workbook =
                DemoPackageManager.ExtractAndOpen(
                    App,
    ...
    Private Sub CreateRegexDemo_22()
        ...
        End Try
    End Sub
    Private Sub CreateRegexDemo_23()
        Try
            Dim workbook As Excel.Workbook =
                DemoPackageManager.ExtractAndOpen(
                    App,
        ...
        End Try
    End Sub
    Private Sub CreateRegexDemo_24()
        Try
            Dim workbook As Excel.Workbook =
                DemoPackageManager.ExtractAndOpen(
                    App,
    ...
    Private Sub CreatePQ_Formel_Demo()
        ...
        End Try
    End Sub
    Private Sub CreatePQ_Formel_1_Demo()
        Try
            Dim workbook As Excel.Workbook =
                DemoPackageManager.ExtractAndOpen(
                    App,
                    "Demo_PQ_Formel_1.zip",
                    "Demo_PQ_Formel_1")
            workbook.Activate()
        Catch ex As Exception
            MessageBox.Show(
        ...
        End Try
    End Sub
    Private Sub CreatePQ_Formel_Pivot_Demo()
        Try
            Dim workbook As Excel.Workbook =
                DemoPackageManager.ExtractAndOpen(
                    App,
                    "Demo_PQ_Formel_Pivot.zip",
                    "Demo_PQ_Formel_Pivot")
            workbook.Activate()
        Catch ex As Exception
            MessageBox.Show(
                "Das Power-Query-Beispiel konnte nicht geöffnet werden." &
